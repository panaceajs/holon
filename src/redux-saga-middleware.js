...
} from 'redux-saga/internal/utils';
import { stdChannel } from 'redux-saga/internal/channel';
import { identity } from 'redux-saga/internal/utils';
import { runSaga } from 'redux-saga/internal/runSaga';

const wrappedRunSaga = (...args) => runSaga.apply(null, ...args);
...
export default function sagaMiddlewareFactory({
  ...
  function sagaMiddleware({ getState, dispatch }) {
    ...
    sagaMiddleware.run = wrappedRunSaga.bind(null, {
      context,
      channel,
      dispatch,
      getState,
